...
public class Arithmetic
{
 ...
 public static void main(String args[])
 {
  ...
  System.out.println("What operation would u like to carry out?\n Either +(addition),\n -(subtraction),\n *(multiplication),\n /(division)\n or %(modular division).\nType 'quit' to exit program.");
  ...
  while(!(input.equals("quit")))
  {
   ...
   {
    System.out.println("You have not entered a valid operation.");
   }

   System.out.println("What operation would u like to carry out? Either +, -, *, / or %.\nType 'quit' to exit program.");
   input = in.next();
  }
 }
 ...
 {
  System.out.println("Enter values to add (maximum of 10 numbers). Then type '=' to get total;");
  Scanner inAdd = new Scanner(System.in);
  for(int i = 0; i < 10; i++)
  {   
   System.out.println("Type another number to add");
 ...
 public void Division()
 {
  ...
  double value1 = doubleparsedouble(valueOne);
